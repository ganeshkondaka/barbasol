...
export default function Hero() {
    return (
        <div className='flex flex-col items-center justify-center mt-16 bg-zinc-950 text-white'>
            ...
            <div className='text-center text-zinc-500 text-[13px] md:text-sm mt-6 '>19-in-1 AI tool suite for all your content needs. <br /> Generate hashtags, titles, debug code, and more with just one click. <br /> &#40; just like Barbasol 😆 &#41; </div>
            ...
            <div className='flex flex-col items-center justify-center text-zinc-600 mt-10'>
                <div className='text-[12px]'>Experience the power of our 19-in-1 AI suite</div>
                <div className='flex flex-row items-center justify-center gap-2 text-3xl mt-4'>
                    <TbBrandNextjs /><BiLogoTypescript /><RiTailwindCssFill /><RiGeminiFill /><SiRazorpay className='text-2xl'/>
