    ...
    <div className='min-h-screen bg-zinc-900 text-white p-4 flex flex-col items-center w-full'>
      ...
      <div className='w-full space-y-4'>
        <div className='hidden lg:block'>
          <div className='flex text-center md:flex-row items-center md:items-center justify-between border border-zinc-700 rounded-lg p-4 bg-zinc-800 shadow-md space-y-2 md:space-y-0 md:space-x-4'>
            <p>Template</p>
            <p>Input</p>
            <p>Ai response</p>
            <p>Date</p>
        ...
        {loading ? (
          ...
          history.map((item: any, index) => (
            <div key={index} className='flex flex-col md:flex-row items-start md:items-center justify-between border border-zinc-700 rounded-lg p-4 bg-zinc-800 shadow-md space-y-2 md:space-y-0 md:space-x-4'>
              ...
              <p className='text-sm md:text-base text-gray-400 flex-1 inline'>{item.ai_response.slice(0, 100)}...</p>
              <p className='text-sm text-gray-500 flex-1 text-center'>{item.date.slice(0, 10)}</p>
              <button
